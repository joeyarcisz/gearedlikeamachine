...
export const faqItems = [
  {
    ...
    answer:
      "We offer a full range of video production services including brand films, commercials, social media content, documentaries, music videos, live event coverage, corporate videos, and paid media assets. Every project is shot in cinema-grade 4K+ quality.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Timeline depends on the project scope. Social media content can be turned around in 1-2 weeks. Brand films and commercials typically take 3-6 weeks from concept to delivery. We pride ourselves on efficient workflows without sacrificing quality.",
  },
  {
    question: "Do you work with clients outside of Dallas-Fort Worth?",
    answer:
      "Absolutely. While we're based in Dallas-Fort Worth, we work with clients nationwide. We've produced content across Texas, the Southwest, and beyond. Travel costs are included in project quotes for out-of-area shoots.",
  },
  {
